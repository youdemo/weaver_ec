...
public class HrmResourceBean {
	...
	private Map<String,String> cusMap2;
	
	public Map<String,String> getCusMap(){
		return cusMap;
	}
	public Map<String,String> getCusMap2(){
		return cusMap2;
	}
	...
	public void addCusMap2(String key,String value){
		if(cusMap2 == null)
			cusMap2 = new HashMap<String,String>();
		cusMap2.put(key, value);
	}
...
//			password = "1";
//		
//		return Util.getEncrypt(password);tu
		return password;
	}
	...
	public String getNationalityID() {
		...
		//log.writeLog("同步国家nationality:"+nationality+"aaa");
		...
		if(nationalityID < 1){
			...
			log.writeLog("同步国家nationality sql:"+sql+"aaa nationality:"+nationality+"aa");
			rs.executeSql(sql);
