...
public class CopyOfFileUpload  extends BaseBean
{
    ...
    public CopyOfFileUpload(HttpServletRequest request)   {
    ...
    public CopyOfFileUpload(HttpServletRequest request,String encode)   {
    	this.remoteAddr=request.getRemoteAddr();
    ...
    public CopyOfFileUpload(HttpServletRequest request,String encode,boolean iszip ,String isEmail)   {
    	this.remoteAddr=request.getRemoteAddr();
    ...
    public CopyOfFileUpload(HttpServletRequest request,String encode,boolean iszip)   {
    	this.remoteAddr=request.getRemoteAddr();
        if (isMultipartData(request)) mpdata = getAttachment(request,encode,iszip);
        this.request = request ;
        this.xss = new XssUtil();
    }
    public CopyOfFileUpload(HttpServletRequest request,String encode,boolean iszip,boolean isoriginal)   {
    	this.remoteAddr=request.getRemoteAddr();
...
//for license upload by chenyingjie 2003-06-26
    public CopyOfFileUpload(HttpServletRequest request,boolean iszip)   {
    	this.remoteAddr=request.getRemoteAddr();
        if (isMultipartData(request)) mpdata = getAttachment(request,iszip);
        this.request = request ;
    }
    
    public CopyOfFileUpload(HttpServletRequest request,boolean iszip,boolean isaesencrypt)   {
    	this.remoteAddr=request.getRemoteAddr();
    ...
    public CopyOfFileUpload(HttpServletRequest request,boolean iszip,String strDirAddr)   {
    	this.remoteAddr=request.getRemoteAddr();
	...
	//html模板图片保存
	public CopyOfFileUpload(HttpServletRequest request,boolean iszip,boolean encoding,String strDirAddr)   {
